<?php $this->layout("layouts/base", ['title' => 'Daily Repair Report']); ?>
...
<div class="panel panel-default" style="max-width: 400px; margin: 0 auto;">
	<div class="panel-heading">Daily Repair Report</div>
	<div class="panel-body">
		<form id="final_ins_params" method="post" action="<?php echo APP_ROOT; ?>/report/dailyrepair/pdf"  target="_blank">
