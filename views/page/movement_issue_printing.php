		...
		<table border="0" cellpadding="10" autosize="2.4">
          ...
          <td align="left">
       	...
       	<tr style="border: 0;">
					...
					<br>_________________________________________<br><br>Production Division Head
					</td>
					<td width="33%" style="border: 0;">
					<br>_________________________________________<br><br>Deputy Plant Manager / Plant Manager
					</td>
       	</tr>
       	<tr style="border: 0;">
					<td width="34%" style="border: 0;">
