			...
			<thead>
				<tr>
					<th colspan="2" align="left">
						<a class="navbar-brand"><img src="./assets/images/header_logo_report.png" style="padding-left:10px;height:20px; width:200px;" /></a>
					</th>
                    
					<th align="center" colspan="3" class="f12" style="border-right: 0;">
						<span style="font-size: 1.5em;"><b><?php echo $title; ?> <br>(เบิกนำกลับ)</br></b></span>
						<!-- <br> <b>รายงานการเบิกยาง</b> -->
					</th>
                    <th>
