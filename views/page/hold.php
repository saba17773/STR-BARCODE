			...
			<div class="alert alert-warning" role="alert"  style="visibility: hidden">
				<div style="text-align: center;">
					<label class="radio-inline">
						<input type="radio" name="holdtype" value="1" style="width: 1.5em; height: 1.5em;" checked required>
						<span style="padding-left: 10px; font-size: 1.4em;"><b> Normal</b></span>
					</label>
					<label class="radio-inline">
						<input type="radio" name="holdtype" value="2" style="width: 1.5em; height: 1.5em;" required>
						<span style="padding-left: 10px; font-size: 1.4em;"><b> Mode Light Buff</b></span>
					</label>
				</div>
			</div>
			<!-- <div class="form-group">
