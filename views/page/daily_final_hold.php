<?php $this->layout("layouts/base", ['title' => 'Daily Final Hold']); ?>
...
<div class="panel panel-default" style="max-width: 400px; margin: 0 auto;">
	<div class="panel-heading">Daily Final Hold</div>
	<div class="panel-body">
		<form id="daily_final_hold_params" method="post" action="<?php echo APP_ROOT; ?>/report/daily_final_hold_report"  target="_blank">
			<div class="form-group">
				<label for="param_date">Date</label>
				<input type="text" id="param_date" name="param_date" class="form-control" autofocus required>
			</div>

			<div class="form-group">
				<label for="param_shift">Shift</label>
				<select name="param_shift" id="param_shift" class="form-control" required>
					<option value="1">กลางวัน (08.01 น. - 20.00 น.)</option>
					<option value="2">กลางคืน (20.01 น. - 08.00 น.)</option>
				</select>
			</div>
			...
			<div class="form-group">
				<b style="padding-right: 40px;">Type : </b>
				<label for="param_type" style="padding-right: 40px;">
					<input type="radio" name="param_type" value="tbr">
					TBR
				</label>
				<label for="param_type" style="padding-right: 40px;">
			...
			<div class="form-group">
				<b style="padding-right: 40px;">Hold : </b>
				<label for="holdtype" style="padding-right: 15px;">
					<input type="radio" name="holdtype" value="1">
					Normal
				</label>
				<label for="holdtype" style="padding-right: 40px;">
					<input type="radio" name="holdtype" value="2">
					Mode Light Buff
				</label>
			</div>
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$('#to_pdf').on('click', function(event) {
	        ...
	        $('#daily_final_hold_params').submit();
