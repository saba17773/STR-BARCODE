<?php $this->layout("layouts/base", ["title" => "Report Greentire Repair Final"]) ?>
<style>
    .btn-xl {
        padding: 5px 45px;
        font-size: 20px;
...
<div class="panel panel-default" style="max-width: 500px; margin: auto;">
    <div class="panel-heading">Final Repair Report</div>
    <div class="panel-body">
        <form id="formDateScrap" method="post" action="/report/greentire/greentireRepairFinalPdf" target="_blank">
            <div class="form-group">
                <label for="date_scrap">Date Repair</label>
