...
header("Content-Disposition: attachment; filename=Greentire_Repair_Report_" . Date("Ymd_His") . ".xls");
// echo "<pree>";
// print_r($data);
// print_r($_SESSION);
// echo "</pree>";
    ...
    <table width="100%" border="1" cellspacing="0">
        <tr>
            ...
            <td colspan="7">
                ...
                <center>
                    <div>Greentire Repair Report</div>
                </center>
            </td>
        </tr>
        <tr>
        ...
        <tbody>
            ...
            <?php foreach ($data_ as $value) { ?>
                <tr>
                    ...
                    <td style="padding: 5px;"><?php echo $value["BuildingNo"]; ?></td>
