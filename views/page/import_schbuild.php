<?php $this->layout("layouts/base", ['title' => 'Import Schedule Building']); ?>
<div class="head-space"></div>

<div class="panel panel-default" style="max-width: 700px; margin: auto;">
	<div class="panel-heading">Import Schedule Building</div>
	<div class="panel-body">
		...
		<form action="<?php echo APP_ROOT; ?>/api/import/schbuild" method="post" enctype="multipart/form-data">
			<div class="form-group">
				<input type="file" name="import_schbuild" required>
			</div>
...
<div class="panel panel-info" style="max-width : 700px; margin: auto;">
	...
	<div class="panel-body">
		<img src="/resources/example/schedule_build.png">
	</div>
</div>
...
<script>
	jQuery(document).ready(function($) {
		$('form').on('submit', function(event) {
			if (!confirm('คุณต้องการ Import Schedule Building ใช่หรือไม่?')) {
