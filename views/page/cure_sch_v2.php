...
<div class="panel panel-default" id="panel2">
    <div class="panel-heading">Cure Import Schedule</div>
    <div class="panel-body">
        <div class="btn-panel">
            <!-- <button class="btn btn-success" id="line"><span class="glyphicon glyphicon-list"></span> Line</button> -->
            <a href="<?php echo APP_ROOT; ?>/import/schcure" class="btn btn-info" id="import" style="background: #9457eb;" target="_blank"><span class="glyphicon glyphicon-import"></span> Import</a>
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        $('#download').on('click', function() {
            window.open("/download/schcure/" + date_inter + "/" + shift);
        });
        ...
        function bindGridSch(shift, date_inter) {
            var dataAdapter = new $.jqx.dataAdapter({
                ...
                url: base_url + '/api/schcure/cureGrid/' + shift + '/' + date_inter
            });
