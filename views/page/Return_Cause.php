<?php $this->layout("layouts/base", ["title" => "Return Cause"]); ?>

<div class="head-space"></div>

<div class="panel panel-default">
  <div class="panel-heading">Return Cause</div>
...
jQuery(document).ready(function($) {
  ...
  $('#create').on('click', function(event) {
	...
	$('#formRequsitionNote').on('submit', function(event) {
		...
		gojax_f('post', base_url+'/api/requsition_note/save1', '#formRequsitionNote')
			.done(function(data) {
				if (data.status == 200) {
...
function grid_requsition() {
    ...
    datatype: 'json',
        ...
        updaterow: function (rowid, rowdata, commit) {
          ...
          gojax('post', base_url+'/api/requsition_note/save1', {
            _id: rowdata.Id,
        ...
        url: base_url + "/api/ReturnCause/all"
  });
