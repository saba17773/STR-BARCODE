<?php $this->layout("layouts/base", ['title' => 'Withdrawal No.']); ?>
 ...
 //console.log(dataAdapter);
    return $("#grid_line_row").jqxGrid({
      ...
      columns: [
        ...
        { text: 'Batch', datafield: 'Batch', width: 80},
        { text: 'Requisition Note', datafield: 'RN', width: 300},
        { text: 'QTY', datafield: 'QTY', width: 50},
        { text: 'Remain', datafield: 'Remain', width: 50},
        { text: 'Issue', datafield: 'Issue', width: 50},
				{ text: 'Status', datafield: 'StatusName', width: 100, filtertype: 'checkedlist',
	        cellsrenderer: function (index, datafield, value, defaultvalue, column, rowdata) {
	          var cl;
