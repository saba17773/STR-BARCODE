<?php $this->layout("layouts/base", ["title" => "Report Greentire Scrap For Account"]) ?>
<style>
    .btn-xl {
        padding: 5px 45px;
        font-size: 20px;
...
<div class="panel panel-default" style="max-width: 500px; margin: auto;">
    <div class="panel-heading">Report Greentire Scrap For Account</div>
    <div class="panel-body">
        <form id="formDateScrap" method="post" action="<?php echo APP_ROOT; ?>/report/greentire/greentireScrapAccPdf" target="_blank">
