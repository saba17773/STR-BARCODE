<?php $this->layout("layouts/base", ["title" => "Building Account Report"]); ?>

<div class="head-space"></div>

<div class="panel panel-default" style="max-width: 500px; margin: auto;">
    <div class="panel-heading">Building Report For Account</div>
    <div class="panel-body">
        <form action="<?php echo APP_ROOT; ?>/report/building_acc/pdf" method="post">
            <div class="form-group">
                <label for="date">Date</label>
                <input type="text" id="date_building" name="date_building" class=form-control required placeholder="เลือกวันที่..." autocomplete="off" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="selectMenuBOI[]" id="selectMenuBOI" multiple="multiple" style="width: 468px" required>
                </select>
