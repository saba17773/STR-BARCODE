...
<div class="panel panel-default" style="max-width: 500px; margin: auto;">
	...
	<div class="panel-body">
		<form action="<?php echo APP_ROOT; ?>/report/greentire/hold_unhold_repair/pdf" method="post">
			...
			<div class="form-group">
							...
							<select name="selectMenuBOI[]" id="selectMenuBOI" multiple="multiple"   style="width: 22%" >
							</select>
			</div>
