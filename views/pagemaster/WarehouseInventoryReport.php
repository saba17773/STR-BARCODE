<?php $this->layout("layouts/base", ['title' => 'Report  Warehouse Inventory Onhand']); ?>
<style>
    .btn-xl {
        padding: 5px 40px;
        font-size: 20px;
...
<div class="panel panel-default form-center">
    <div class="panel-heading">Report Warehouse Inventory Onhand</div>
    <div class="panel-body">
        <form id="form_building" method="post" action="<?php echo APP_ROOT; ?>/api/pdf/warehouseonhand" target="_blank">
