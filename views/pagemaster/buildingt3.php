<?php $this->layout("layouts/base", ['title' => 'Building New']); ?>
<style>
.btn-xl {
    padding: 5px 22px;
    font-size: 20px;
...
<h1 class="head-text">Building New Report</h1>
<hr>
<div class="panel panel-default" style="max-width: 400px; margin: 0 auto;">
  <div class="panel-body">
    <form id="form_building" method="post" action="<?php echo APP_ROOT; ?>/api/pdf/buildingt3">
