<?php $this->layout("layouts/base", ["title" => "Report Scrap Checking"]) ?>
<style>
.btn-xl {
    padding: 5px 45px;
    font-size: 20px;
...
<div class="panel panel-default" style="max-width: 500px; margin: auto;">
	<div class="panel-heading">Scrap Checking</div>
	<div class="panel-body">
	    <form id="formDateScrap" method="post" action="<?php echo APP_ROOT; ?>/report/ScrapCheckingPdf" target="_blank">
			<div class="form-group">
				<label for="date_scrap">Date</label>
                <input type="text" id="date_scrap" name="date_scrap" class=form-control required  
