<?php $this->layout("layouts/base", ['title' => 'Greentire Inspection']); ?>
<style>
.btn-xl {
    padding: 5px 22px;
    font-size: 20px;
...
<div class="panel panel-default" style="max-width: 400px; margin: 0 auto;">
			<div class="panel-heading">Greentire Inspection</div>
  <div class="panel-body">
		<form id="form_building" method="post" action="<?php echo APP_ROOT; ?>/api/pdf/greentireinspection" target="_blank">
