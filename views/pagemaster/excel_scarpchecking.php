...
header("Content-Disposition: attachment; filename=Scrap_Checking_Report_".Date("Ymd_His").".xls");
// echo "<pree>";
// print_r($data);
// print_r($_SESSION);
// echo "</pree>";
...
<meta charset="UTF-8">
	...
	<title>Scrap Checking Report XCell </title>
	<style>
		body {
			font-size: 0.8em;
		}
...
<body>
    ...
    <thead>
      <tr>
  			...
  			<td align="center" colspan="9" class="f14">
  				<b>SIAMTRUCK RADIAL CO.LTD.</b> <br> <b>Scrap Checking Report</b>
  			</td>
  		</tr>
  		<tr>
  			<td align="left" colspan="11" class="f10">
    ...
    <tbody>
          ...
          <td style="padding: 5px;"><?php	if ($value["DateBuild"] === null || $value["DateBuild"] === "") {
              ...
              echo $createdate;
					...
					<td style="padding: 5px;">
						<?php
							if ($value["DATECHECK"] === null || $value["DATECHECK"] === "") {
								echo "-";
							} else {
								$createdate = date('d-m-Y H:i', strtotime($value["DATECHECK"]));
								echo $createdate;
							}
						?>
					</td>
