...
<div class="container">
    <table >
        ...
        echo "<tr>";
            ...
            echo "<td class='f12' width='10%'>เครื่อง</td>";
        ...
        echo "</tr>";
            ...
            foreach ($data as $key => $value) 
            {
                ...
                echo "<tr>";
                    ...
                    echo "<td class='f12'>".$value["Machine"]."</td>";
            ...
            echo "<tr>";
                 echo "<td class='f12' colspan='6' align='right' >Total :  </td>";
                    echo "<td class='f12' colspan='1'  >".$total."</td>";
                echo "</tr>";
		?>
    </table>
